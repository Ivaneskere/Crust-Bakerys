...
export default function Products() {
    ...
    const [selected, setSelected] = useState(location.state?.openProduct || null);
    const [sortBy, setSortBy] = useState('none')
    useEffect(() => {
        if (location.state?.openProduct) {
            setSelected(location.state.openProduct);
        }
    }, [location.state]);
                    ...
                    <div className="-mt-10 rounded-3xl bg-[#f3eadb] p-6 shadow-sm ring-1 ring-black/5 sm:p-10">
                        ...
                        <div className="mb-6 flex items-center gap-3">
                            ...
                            <button
                                ...
                                className={`rounded-lg px-3 py-2 text-sm font-medium transition-all ${sortBy === 'none'
                            ...
                            <button
                                ...
                                className={`rounded-lg px-3 py-2 text-sm font-medium transition-all ${sortBy === 'asc'
                                    ? 'bg-[#7b4a2a] text-white shadow-md'
                                    : 'bg-white ring-1 ring-black/5 hover:ring-black/10'
                                    }`}
                            >
                            ...
                            <button
                                ...
                                className={`rounded-lg px-3 py-2 text-sm font-medium transition-all ${sortBy === 'desc'
                                    ? 'bg-[#7b4a2a] text-white shadow-md'
                                    : 'bg-white ring-1 ring-black/5 hover:ring-black/10'
                                    }`}
                            >
                        ...
                        <div className="relative z-10 w-full max-w-2xl rounded-2xl bg-white p-6">
                            ...
                            <div className="mt-4 flex justify-end">
                                <button
                                    ...
                                    className="rounded-md px-3 py-2 bg-white ring-1 ring-black/5"
                                    >  
                                    Закрити
                                    </button>
                            </div>
